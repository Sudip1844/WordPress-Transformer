<?php
/**
 * Template Name: WhatsApp QR Code Generator
...
<section class="qr-page-hero">
    <div class="container">
        <h1 class="qr-page-title">
            <span class="dynamic-neon-title">WhatsApp QR Code Generator</span>
        </h1>
        <p class="qr-page-desc">
            Create a QR code that opens WhatsApp with your number and optional pre-filled message.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="generator-wrapper">
            <div class="form-section">
                <form id="whatsapp-qr-form">
                    <div class="form-group">
                        <label for="phone-input">WhatsApp Number (with country code)</label>
                        <input type="tel" id="phone-input" class="form-input" placeholder="1234567890 (no + or spaces)" required>
                    </div>
                    <div class="form-group">
                        <label for="message-input">Pre-filled Message (Optional)</label>
                        <textarea id="message-input" class="form-textarea" placeholder="Hello! I scanned your QR code..."></textarea>
                    </div>
                </form>
            </div>
            ...
            <div class="preview-section">
                <div class="qr-preview" id="qr-preview">
                    <p style="color: #64748b;">Enter WhatsApp number to generate QR code</p>
                </div>
    ...
    <div class="container">
        <div class="info-grid">
            <div class="info-card">
                <h3>Benefits</h3>
                <ul>
                    <li>Direct message to your WhatsApp</li>
                    <li>Perfect for business customer support</li>
                    <li>Pre-fill messages for context</li>
                    <li>Works globally with any WhatsApp number</li>
                </ul>
            </div>
            <div class="info-card">
                <h3>Use Cases</h3>
                <ul>
                    <li>Business customer support</li>
                    <li>Personal contact sharing</li>
                    <li>Sales and inquiry channels</li>
                    <li>Event organizer contact</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateQR() {
        ...
        if (!phone) {
            qrPreview.innerHTML = '<p style="color: #64748b;">Enter WhatsApp number to generate QR code</p>';
        ...
        if (messageInput.value.trim()) {
            waUrl += '?text=' + encodeURIComponent(messageInput.value.trim());
        }
    ...
    downloadSvg.addEventListener('click', function() {
        ...
        QRCode.toString(currentQRData, { type: 'svg', width: 1024, margin: 4 }, function(error, svg) {
            ...
            const link = document.createElement('a');
            link.download = 'whatsapp-qrcode.svg';
