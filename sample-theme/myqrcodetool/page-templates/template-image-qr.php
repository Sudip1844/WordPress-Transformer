<?php
/**
 * Template Name: Image QR Code Generator
...
<section class="qr-page-hero">
    <div class="container">
        <h1 class="qr-page-title">
            <span class="dynamic-neon-title">Image QR Code Generator</span>
        </h1>
        <p class="qr-page-desc">
            Create a QR code that links to an image URL. Perfect for sharing photos, artwork, and visual content.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="generator-wrapper">
            <div class="form-section">
                <form id="image-qr-form">
                    <div class="form-group">
                        <label for="image-url">Image URL</label>
                        <input type="url" id="image-url" class="form-input" placeholder="https://example.com/image.jpg" required>
                    </div>
                    <p style="color: #94a3b8; font-size: 0.875rem;">Enter the direct URL to an image file (JPG, PNG, GIF, etc.)</p>
                </form>
            </div>
            
            <div class="preview-section">
                <div class="qr-preview" id="qr-preview">
                    <p style="color: #64748b;">Enter an image URL to generate QR code</p>
                </div>
    ...
    <div class="container">
        <div class="info-grid">
            <div class="info-card">
                <h3>Benefits</h3>
                <ul>
                    <li>Share images without sending large files</li>
                    <li>Perfect for portfolios and galleries</li>
                    <li>Works with any image hosting service</li>
                    <li>Great for print materials linking to visuals</li>
                </ul>
            </div>
            <div class="info-card">
                <h3>Use Cases</h3>
                <ul>
                    <li>Artist and photographer portfolios</li>
                    <li>Product images on packaging</li>
                    <li>Menu photos in restaurants</li>
                    <li>Real estate property photos</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateQR() {
        ...
        if (!url) {
            qrPreview.innerHTML = '<p style="color: #64748b;">Enter an image URL to generate QR code</p>';
    ...
    imageUrlInput.addEventListener('input', generateQR);
    ...
    downloadPng.addEventListener('click', function() {
        ...
        QRCode.toCanvas(canvas, currentQRData, { width: 1024, margin: 4 }, function(error) {
            ...
            link.download = 'image-qrcode.png';
    ...
    downloadSvg.addEventListener('click', function() {
        ...
        QRCode.toString(currentQRData, { type: 'svg', width: 1024, margin: 4 }, function(error, svg) {
            ...
            const link = document.createElement('a');
            link.download = 'image-qrcode.svg';
