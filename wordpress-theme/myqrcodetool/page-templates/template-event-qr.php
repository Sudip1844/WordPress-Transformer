<?php
/**
 * Template Name: Event QR Code Generator
...
<style>
    ...
    .form-input, .form-textarea { width: 100%; padding: 0.75rem 1rem; background: #1e293b; border: 1px solid #334155; border-radius: 0.5rem; color: white; font-size: 0.9rem; }
...
<section class="qr-page-hero">
    <div class="container">
        <h1 class="qr-page-title">
            <span class="dynamic-neon-title">Event QR Code Generator</span>
        </h1>
        <p class="qr-page-desc">
            Create a QR code that adds events directly to calendar apps like Google Calendar and Apple Calendar.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="generator-wrapper">
            <div class="form-section">
                <form id="event-qr-form">
                    <div class="form-grid">
                        <div class="form-group full-width">
                            <label for="event-title">Event Title *</label>
                            <input type="text" id="event-title" class="form-input" placeholder="Team Meeting" required>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="location" class="form-input" placeholder="Conference Room A">
                        </div>
                        <div class="form-group full-width">
                            <label for="description">Description</label>
                            <textarea id="description" class="form-textarea" placeholder="Event details..."></textarea>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="preview-section">
                <div class="qr-preview" id="qr-preview">
                    <p style="color: #64748b;">Enter event details to generate QR code</p>
                </div>
    ...
    <div class="container">
        <div class="info-grid">
            <div class="info-card">
                <h3>Benefits</h3>
                <ul>
                    <li>One scan to add event to any calendar</li>
                    <li>Works with Google, Apple, Outlook calendars</li>
                    <li>Include all event details automatically</li>
                    <li>Perfect for invitations and tickets</li>
                </ul>
            </div>
            <div class="info-card">
                <h3>Use Cases</h3>
                <ul>
                    <li>Wedding and party invitations</li>
                    <li>Conference and seminar schedules</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateEvent() {
        ...
        if (fields.location.value.trim()) ics += 'LOCATION:' + fields.location.value.trim() + '\n';
        if (fields.description.value.trim()) ics += 'DESCRIPTION:' + fields.description.value.trim().replace(/\n/g, '\\n') + '\n';
        ics += 'END:VEVENT\nEND:VCALENDAR';
        return ics;
    }
    ...
    function generateQR() {
        ...
        if (!event) {
            qrPreview.innerHTML = '<p style="color: #64748b;">Enter event details to generate QR code</p>';
    ...
    downloadSvg.addEventListener('click', function() {
        ...
        QRCode.toString(currentQRData, { type: 'svg', width: 1024, margin: 4 }, function(error, svg) {
            ...
            const link = document.createElement('a');
            link.download = 'event-qrcode.svg';
