<?php
/**
 * Template Name: PayPal QR Code Generator
...
<style>
    ...
    .form-input, .form-select { width: 100%; padding: 0.875rem 1rem; background: #1e293b; border: 1px solid #334155; border-radius: 0.5rem; color: white; font-size: 1rem; }
...
<section class="qr-page-hero">
    <div class="container">
        <h1 class="qr-page-title">
            <span class="dynamic-neon-title">PayPal QR Code Generator</span>
        </h1>
        <p class="qr-page-desc">
            Create a QR code that links to your PayPal.me page for easy payments and donations.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="generator-wrapper">
            <div class="form-section">
                <form id="paypal-qr-form">
                    <div class="form-group">
                        <label for="paypal-username">PayPal.me Username</label>
                        <input type="text" id="paypal-username" class="form-input" placeholder="yourname" required>
                    </div>
                    <div class="form-group">
                        <label for="amount">Amount (Optional)</label>
                        <input type="number" id="amount" class="form-input" placeholder="10.00" step="0.01" min="0">
                    </div>
                    <div class="form-group">
            ...
            <div class="preview-section">
                <div class="qr-preview" id="qr-preview">
                    <p style="color: #64748b;">Enter PayPal username to generate QR code</p>
                </div>
    ...
    <div class="container">
        <div class="info-grid">
            <div class="info-card">
                <h3>Benefits</h3>
                <ul>
                    <li>Accept payments easily with one scan</li>
                    <li>Perfect for freelancers and small businesses</li>
                    <li>Pre-set amounts for fixed pricing</li>
...
document.addEventListener('DOMContentLoaded', function() {
    const usernameInput = document.getElementById('paypal-username');
    ...
    function generateQR() {
        ...
        if (!username) {
            qrPreview.innerHTML = '<p style="color: #64748b;">Enter PayPal username to generate QR code</p>';
        ...
        if (amountInput.value) {
            url += '/' + amountInput.value + currencySelect.value;
        }
    ...
    currencySelect.addEventListener('change', generateQR);
    ...
    downloadPng.addEventListener('click', function() {
        ...
        QRCode.toCanvas(canvas, currentQRData, { width: 1024, margin: 4 }, function(error) {
            ...
            link.download = 'paypal-qrcode.png';
    ...
    downloadSvg.addEventListener('click', function() {
        ...
        QRCode.toString(currentQRData, { type: 'svg', width: 1024, margin: 4 }, function(error, svg) {
            ...
            const link = document.createElement('a');
            link.download = 'paypal-qrcode.svg';
