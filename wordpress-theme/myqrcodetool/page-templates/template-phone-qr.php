<?php
/**
 * Template Name: Phone QR Code Generator
...
<section class="qr-page-hero">
    <div class="container">
        <h1 class="qr-page-title">
            <span class="dynamic-neon-title">Phone QR Code Generator</span>
        </h1>
        <p class="qr-page-desc">
            Create a QR code for any phone number. Customers can scan and call you instantly with one tap.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="info-grid">
            <div class="info-card">
                <h3>Benefits</h3>
                <ul>
                    <li>One scan to call - no dialing required</li>
                    <li>Perfect for business cards and marketing</li>
            ...
            <div class="info-card">
                ...
                <ul>
                    ...
                    <li>Sales and support contacts</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    downloadPng.addEventListener('click', function() {
        ...
        QRCode.toCanvas(canvas, currentQRData, { width: 1024, margin: 4 }, function(error) {
            ...
            link.download = 'phone-qrcode.png';
    ...
    downloadSvg.addEventListener('click', function() {
        ...
        QRCode.toString(currentQRData, { type: 'svg', width: 1024, margin: 4 }, function(error, svg) {
            ...
            const link = document.createElement('a');
            link.download = 'phone-qrcode.svg';
